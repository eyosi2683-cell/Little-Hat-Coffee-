...
export default function MenuSection({ onAddToDraft, latteArtImg, wafflesImg }: MenuSectionProps) {
  ...
  const tabs: { id: CategoryTab; label: string; icon: any }[] = [
    ...
    { id: 'coffee', label: 'Espresso & Lattes', icon: Coffee },
    { id: 'iced', label: 'Matcha & Specialty', icon: Flame },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-sm text-gray-600">
            All prices listed in <span className="font-bold text-[#1E110A]">US Dollars ($)</span>. <br className="hidden sm:inline" />
            Cash, card, and mobile pay accepted in-store.
          </p>
        </div>
