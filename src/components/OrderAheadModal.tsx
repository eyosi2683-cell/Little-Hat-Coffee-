...
export default function OrderAheadModal({
  ...
  const [loadingText, setLoadingText] = useState('Connecting to Little Hat Coffee bar...');
  ...
  const startCheckoutSimulation = () => {
    ...
    setLoadingText('Transmitting ticket to Streets Market bar...');
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <span className="block text-[10px] text-gray-500 font-mono mt-2 leading-relaxed">
                      *We collect final payment on-site at pickup. Cash, card, and mobile pay accepted!
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-3 leading-relaxed max-w-xs">
                    Your order has been loaded directly into the barista's display queue at Little Hat Coffee.
                  </p>
                </div>
