      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start text-left">
          ...
          >
            ...
            Columbia Heights’ Favorite Neighborhood Spot
          </motion.div>
          ...
          >
            Welcome to <span className="text-white font-medium">Little Hat Coffee</span>, a cozy espresso bar tucked inside Streets Market serving specialty matcha, cortados, and pastries from local DC vendors. Whether you're grabbing a quick drink or settling in at the bar, find your home with us on 14th Street.
          </motion.p>
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center">
          ...
          >
            ...
            <img
              src={heroImage}
              alt="Little Hat Coffee Interior"
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-[#1E110A]/90 backdrop-blur-md p-4 rounded-xl border border-[#3D2516]/50 flex justify-between items-center text-left">
              <div>
                ...
                <span className="text-sm font-semibold text-white">A Toda Madre Roasters Beans</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-10 border-t border-[#3D2516]/60 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-xs text-[#EFE3C3]/70 mt-1">Rich, aromatic single-origin espresso paired with house-made syrups.</p>
          </div>
        </div>
        <div className="flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-[#2D1B10] border border-[#3D2516] flex items-center justify-center text-[#C89D7C] shrink-0">
          ...
          <div>
            <h3 className="text-sm font-bold text-white uppercase tracking-wider">Fresh Local Pastries</h3>
            <p className="text-xs text-[#EFE3C3]/70 mt-1">Croissants, donuts, and rotating treats sourced from local DC bakers.</p>
          </div>
        </div>
        <div className="flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-[#2D1B10] border border-[#3D2516] flex items-center justify-center text-[#C89D7C] shrink-0">
