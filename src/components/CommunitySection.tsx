        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 bg-[#25150D] p-6 md:p-8 rounded-2xl border border-[#3D2516] text-left shadow-lg relative" id="add-review-form-wrapper">
            ...
            <p className="text-xs text-gray-400 mb-6">
              Share your review with our DC team. Your rating cups help us serve you better every day!
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="e.g. Columbia Heights, DC OR NYC"
                  value={newLocation}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Tell others about the coffee, matcha, atmosphere, or our team..."
                  value={newComment}
